...
module Sentry
  module Agents
    class SpanBuilderTest < Minitest::Test
      ...
      def test_sentry_available_returns_falsy_when_sentry_not_initialized
        refute_predicate Sentry::Agents::SpanBuilder, :sentry_available?
      end
      ...
      def test_sentry_available_returns_truthy_when_span_exists
        ...
        assert_predicate Sentry::Agents::SpanBuilder, :sentry_available?
      end
