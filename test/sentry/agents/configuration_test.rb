  ...
  module Agents
    class ConfigurationTest < Minitest::Test
      ...
      def test_default_configuration_values
        ...
        refute config.auto_instrument_ruby_llm
        refute config.auto_instrument_langchainrb
      ...
      def test_configure_supports_debug_mode
        ...
        assert Sentry::Agents.configuration.debug
      end
      ...
      def test_configure_supports_auto_instrument_ruby_llm
        ...
        assert Sentry::Agents.configuration.auto_instrument_ruby_llm
      end
      ...
      def test_configure_supports_auto_instrument_langchainrb
        ...
        assert Sentry::Agents.configuration.auto_instrument_langchainrb
      end
      ...
      def test_reset_configuration_restores_defaults
        ...
        refute Sentry::Agents.configuration.debug
      end
